...
exports.GradesModule = GradesModule = __decorate([
    (0, common_1.Module)({
        providers: [grades_service_1.GradesService, grade_calculation_service_1.GradeCalculationService],
        controllers: [grades_controller_1.GradesController],
        exports: [grades_service_1.GradesService, grade_calculation_service_1.GradeCalculationService],
    })
], GradesModule);
