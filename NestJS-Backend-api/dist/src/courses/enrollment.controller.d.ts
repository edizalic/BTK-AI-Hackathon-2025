...
export declare class EnrollmentController {
    ...
    enrollStudent(courseId: string, studentId: string, user: UserWithProfile): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        total: number;
    ...
    bulkEnrollStudents(courseId: string, dto: BulkEnrollStudentsDto, user: UserWithProfile): Promise<{
        success: boolean;
        enrolled: ({
            student: {
                profile: {
