...
exports.QuizzesModule = QuizzesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [quizzes_service_1.QuizzesService, quiz_attempts_service_1.QuizAttemptsService],
        controllers: [quizzes_controller_1.QuizzesController, quiz_attempts_controller_1.QuizAttemptsController],
        exports: [quizzes_service_1.QuizzesService, quiz_attempts_service_1.QuizAttemptsService],
    })
], QuizzesModule);
